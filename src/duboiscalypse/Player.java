...
//        thrustEast.addFrame(playerSpriteSheet.getSprite(7, 7), 150);
        ...
        thrustWest.addFrame(playerSpriteSheet.getSprite(0, 13), 150);
        thrustWest.addFrame(playerSpriteSheet.getSprite(1, 13), 150);

        thrustWest.addFrame(playerSpriteSheet.getSprite(2, 13), 150);

        thrustWest.addFrame(playerSpriteSheet.getSprite(3, 13), 150);

        thrustWest.addFrame(playerSpriteSheet.getSprite(4, 13), 150);

        thrustWest.addFrame(playerSpriteSheet.getSprite(5, 13), 150);
//
//        thrustWest.addFrame(playerSpriteSheet.getSprite(6, 13), 150);
//
//        thrustWest.addFrame(playerSpriteSheet.getSprite(7, 13), 150);

        thrustNorth = new Animation();

        thrustNorth.setAutoUpdate(false);

        thrustNorth.addFrame(playerSpriteSheet.getSprite(0, 12), 150);
        thrustNorth.addFrame(playerSpriteSheet.getSprite(1, 12), 150);

        thrustNorth.addFrame(playerSpriteSheet.getSprite(2, 12), 150);

        thrustNorth.addFrame(playerSpriteSheet.getSprite(3, 12), 150);

        thrustNorth.addFrame(playerSpriteSheet.getSprite(4, 12), 150);

        thrustNorth.addFrame(playerSpriteSheet.getSprite(5, 12), 150);

//        thrustNorth.addFrame(playerSpriteSheet.getSprite(6, 12), 150);
//
//        thrustNorth.addFrame(playerSpriteSheet.getSprite(7, 12), 150);

        thrustSouth = new Animation();

        thrustSouth.setAutoUpdate(false);

        thrustSouth.addFrame(playerSpriteSheet.getSprite(0, 14), 150);
        thrustSouth.addFrame(playerSpriteSheet.getSprite(1, 14), 150);

        thrustSouth.addFrame(playerSpriteSheet.getSprite(2, 14), 150);

        thrustSouth.addFrame(playerSpriteSheet.getSprite(3, 14), 150);

        thrustSouth.addFrame(playerSpriteSheet.getSprite(4, 14), 150);

        thrustSouth.addFrame(playerSpriteSheet.getSprite(5, 14), 150);
